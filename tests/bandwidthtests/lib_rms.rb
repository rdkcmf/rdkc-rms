...
module Rms
  ...
  def Rms.getConnectionsCount(host, verbose = true)
  ...
  def Rms.createHlsStream(host, localStreamNames, targetFolder = @@target_dir, chunklength = 10, playlistlength = 30, keepalive = 1)
  ...
  def Rms.createHlsStreamEncrypted(host, localStreamNames, targetFolder = @@target_dir, chunklength = 10, keepAlive = 1)
  ...
  def Rms.createMssStream(host, localStreamNames, targetFolder = @@target_dir, chunklength = 10, keepAlive = 1)
  ...
  def Rms.removeLastConfig(host, verbose = true)

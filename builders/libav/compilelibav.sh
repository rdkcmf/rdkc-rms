...
# Usage:
#	./compilelibav.sh <destination>
#	./compilelibav.sh /c/gigi
...
./configure --disable-opencl --enable-static --prefix=$WORKING_DIR/out
...
cp $WORKING_DIR/avconv-$OS_NAME-$OS_VERSION-$OS_ARCH.tar.gz ../../../../avconv-$OS_NAME-$OS_VERSION-$OS_ARCH.tar.gz

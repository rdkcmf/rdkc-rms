...
TOOLCHAIN_BASE=/disk2/opt/crisv32/r94/bin/crisv32-axis-linux-gnu-
DESTINATION=/disk2/opt/crisv32/r94/
...
./Configure no-shared --prefix=${DESTINATION} --openssldir=${DESTINATION} ${PLATFORM}
make clean

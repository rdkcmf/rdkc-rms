...
#toolchain path
TOOLCHAIN_BASE=/disk2/opt/liquidimage_mips
TOOLCHAIN_PREFIX=/bin/mipsel-linux-gnu-
...
PLATFORM_INCLUDE = -I/disk2/opt/liquidimage_mips/include
PLATFORM_LIBS = -static -L/disk2/opt/liquidimage_mips/lib -lssl -lcrypto -ldl -lrt  

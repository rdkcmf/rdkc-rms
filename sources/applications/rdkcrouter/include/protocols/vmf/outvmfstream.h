 ...
 */
#ifndef __OUTVMFSTREAM_H__
#define __OUTVMFSTREAM_H__

#include "streaming/baseoutstream.h"
#include "protocols/vmf/outvmfprotocol.h"

class OutVmfProtocol;

class DLLEXP OutVmfStream
: public BaseOutStream {
public:
	OutVmfStream(BaseProtocol *pProtocol, uint64_t type, string name);
...
private:
	bool _attached;
	OutVmfProtocol * pVmfProtocol;
};


#endif // __OUTVMFSTREAM_H__

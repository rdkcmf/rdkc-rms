...
#ifndef _SHUTDOWNTIMERPROTOCOL_H
#define	_SHUTDOWNTIMERPROTOCOL_H
...
namespace app_lminterface {
	...
	public:
		ShutdownTimerProtocol(LMController *pController);
		virtual ~ShutdownTimerProtocol();
		virtual bool TimePeriodElapsed();
	};
}
#endif /* _SHUTDOWNTIMERPROTOCOL_H */

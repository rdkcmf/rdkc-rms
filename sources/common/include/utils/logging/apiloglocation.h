...
#ifndef _APILOGLOCATION_H
#define _APILOGLOCATION_H
...
#endif /* SDK_DISABLED */
class DLLEXP ApiLogLocation : public BaseLogLocation {
public:
	ApiLogLocation(Variant &configuration);
	virtual ~ApiLogLocation();

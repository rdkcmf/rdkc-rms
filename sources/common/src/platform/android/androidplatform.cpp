...
JNIEnv *AndroidPlatform::_pEnv = NULL;
jclass AndroidPlatform::_pClass = NULL;
jmethodID AndroidPlatform::_signalServerStatusMID = NULL;
jmethodID AndroidPlatform::_runtimeStatusMID = NULL;
//jmethodID AndroidPlatform::_readStatusFlagMID = NULL;
jmethodID AndroidPlatform::_shutdownFeedbackMID = NULL;
jmethodID AndroidPlatform::_postLogMID = NULL;
jmethodID AndroidPlatform::_updateChannelsMID = NULL;
string AndroidPlatform::_cacheDirectory;

//ProcessChannelCallback AndroidPlatform::_pAddChannel = NULL;
//ProcessChannelCallback AndroidPlatform::_pRemoveChannel = NULL;
//ProcessBufferCallback AndroidPlatform::_pProcessBuffer = NULL;
...
void AndroidPlatform::SetAndroidEnvParameter(JNIEnv *pEnv, jclass clazz) {
	_pEnv = pEnv;
	_pClass = clazz;
	_signalServerStatusMID = _pEnv->GetStaticMethodID(_pClass, "signalServerShutdown", "()Z");
	_shutdownFeedbackMID = _pEnv->GetStaticMethodID(_pClass, "serverFeedback","(Z)V");
	_postLogMID = _pEnv->GetStaticMethodID(_pClass, "postLog","(ILjava/lang/String;)V");
	_runtimeStatusMID = _pEnv->GetStaticMethodID(_pClass, "setRuntimeStatus", "(Z)V");
	__android_log_print(ANDROID_LOG_FATAL, "rdkcms", "Setting up JNI environment");
	jfieldID envDirID = _pEnv->GetStaticFieldID(clazz, "runtimeEnvironment", "Ljava/lang/String;");
	jstring envDir = (jstring) _pEnv->GetStaticObjectField(clazz, envDirID);
	const char *str = _pEnv->GetStringUTFChars(envDir, NULL);
	_cacheDirectory = string(str) + "/";
	_pEnv->ReleaseStringUTFChars(envDir, str);
}

string AndroidPlatform::GetCacheDirectory() {
	return _cacheDirectory;
}
bool AndroidPlatform::CheckRuntimeStatus() {

	bool shutdownNow = (bool) _pEnv->CallStaticBooleanMethod(_pClass, _signalServerStatusMID);
	if (shutdownNow)
		return false;
...
void AndroidPlatform::SetRuntimeStatus(bool status) {
	_pEnv->CallStaticVoidMethod(_pClass, _runtimeStatusMID, status);
}
/*
void AndroidPlatform::SetCallbacks(ProcessChannelCallback addChannel, ProcessChannelCallback removeChannel, ProcessBufferCallback processBuffer) {
	_pAddChannel = addChannel;
	_pRemoveChannel = removeChannel;
	_pProcessBuffer = processBuffer;
}
*/
void AndroidPlatform::SendShutdownFeedback() {
	__android_log_print(ANDROID_LOG_FATAL, "rdkcms", "Calling shutdownFeedback");
	_pEnv->CallStaticVoidMethod(_pClass, _shutdownFeedbackMID, true);
}

void AndroidPlatform::SendInitializedFeedback() {
	__android_log_print(ANDROID_LOG_FATAL, "rdkcms", "Starting up...");
	_pEnv->CallStaticVoidMethod(_pClass, _shutdownFeedbackMID, false);
}

void AndroidPlatform::Log(int32_t level, string log) {
	jint logLevel = (jint) level;
	jstring logLine = _pEnv->NewStringUTF(STR(log));
	_pEnv->CallStaticVoidMethod(_pClass, _postLogMID, logLevel, logLine);
}

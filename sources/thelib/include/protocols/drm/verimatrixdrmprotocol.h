...
#ifndef _VERIMATRIXDRMPROTOCOL_H
#define	_VERIMATRIXDRMPROTOCOL_H

#include "protocols/drm/basedrmprotocol.h"

class DLLEXP VerimatrixDRMProtocol
: public BaseDRMProtocol {
public:
	VerimatrixDRMProtocol();
	virtual ~VerimatrixDRMProtocol();
protected:
...
#endif	/* _VERIMATRIXDRMPROTOCOL_H */

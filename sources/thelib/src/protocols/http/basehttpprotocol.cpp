...
#define HTTP_MAX_HEADERS_SIZE 16384 // set to 16kb,  orig was 2kb (2048)
...
bool BaseHTTPProtocol::EnqueueForOutbound() {
	...
	_outboundHeaders[HTTP_HEADERS_USER_AGENT] = RTSP_HEADERS_X_POWERED_BY_US;

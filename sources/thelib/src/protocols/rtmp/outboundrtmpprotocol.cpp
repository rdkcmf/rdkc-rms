...
bool OutboundRTMPProtocol::PerformHandshakeStage1(bool encrypted) {
	...
	HMACsha256(pTempBuffer, 1536 - 32, playerKey, 30, pTempHash);
...
bool OutboundRTMPProtocol::VerifyServer(IOBuffer & inputBuffer) {
	...
	HMACsha256(pTempBuffer, 1536 - 32, serverKey, 36, pDigest);
	...
	HMACsha256(_pClientDigest, 32, serverKey, 68, pChallange);
...
bool OutboundRTMPProtocol::PerformHandshakeStage2(IOBuffer &inputBuffer,
	...
	HMACsha256(pInputBuffer + serverDigestOffset, 32, playerKey, 62, pChallangeKey);

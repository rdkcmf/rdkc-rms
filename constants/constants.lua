...
USE_PREBUILT_SSL_CERT="useprebuiltsslcert",
...
CONF_PROTOCOL_OUTBOUND_HTTP2="outboundHttp2",
...
CONF_PROTOCOL_INBOUND_CLI_ASCII="inboundAsciiCli",

-- RPC protocols
CONF_PROTOCOL_INBOUND_RPC="inboundRpc",
CONF_PROTOCOL_INBOUND_SSL_RPC="inboundSslRpc",
CONF_PROTOCOL_INBOUND_HTTP_RPC="inboundHttpRpc",
CONF_PROTOCOL_INBOUND_HTTPS_RPC="inboundHttpsRpc",
...
-- DRM protocols
CONF_PROTOCOL_DRM_HTTP="drmHttp",
CONF_PROTOCOL_DRM_HTTPS="drmHttps",
...
RM="rtmpMessage",
	...
	RM_INVOKE="invoke",
		...
		RM_INVOKE_FUNCTION="functionName",
			...
			RM_INVOKE_FUNCTION_RECEIVEAUDIO="receiveAudio",
			RM_INVOKE_FUNCTION_RECEIVEVIDEO="receiveVideo",
